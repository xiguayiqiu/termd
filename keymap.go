...
var DefaultKeyMap = []Binding{
	...
	{Modes: []EditorMode{ModeNameCommand}, Keys: []string{":set cursor block"}, Action: "cmd.setcursorblock",
		Description: ":set cursor block 光标形状：块", Group: "命令模式命令"},
	{Modes: []EditorMode{ModeNameCommand}, Keys: []string{":set cursor bar"}, Action: "cmd.setcursorbar",
		Description: ":set cursor bar 光标形状：竖线", Group: "命令模式命令"},
	{Modes: []EditorMode{ModeNameCommand}, Keys: []string{":set cursor underline"}, Action: "cmd.setcursorunderline",
		Description: ":set cursor underline 光标形状：下划线", Group: "命令模式命令"},
...
var commandDocs = []commandDoc{
	...
	{":set cursor block", "光标形状：块（默认，实心方块）"},
	{":set cursor bar", "光标形状：竖线（细竖线）"},
	{":set cursor underline", "光标形状：下划线（底部横线）"},
